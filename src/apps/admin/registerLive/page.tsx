...
//                 const data: Item[] = await res.json();  // ✅ 타입 명시
//                 setItems(data);
//             } catch (err) {
//                 console.error(err);
//             }
...
//     //         description,
//     //     };
//     //     console.log("라이브 등록 정보:", liveInfo);
//     //     alert("라이브가 등록되었습니다!");
//     // };
                ...
                <Container size="xl" px={0}>
                    ...
                    <Card shadow="sm" padding="lg" radius="md" withBorder>
                        <Stack spacing="md">
                            ...
                            {/* 상품 아코디언 */}
                            <Box>
                                <Text fw={500} mb="xs">라이브 쇼핑 상품 선택</Text>
                                {items.length === 0 ? (
